# GeniusRouter artifacts/routing_decisions/
...
Routing decision ledger output surface.
...
Outbound Hooks:
- reports/smoke/; reports/validation/

Evidence Surface:
- artifacts/routing_decisions/routing_decisions.jsonl
